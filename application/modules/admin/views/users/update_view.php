                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group <?= (form_error('last_name')) ? 'has-error' : '' ?>">
                                                  ...
                                                  <input type="text" name="last_name" class="form-control" placeholder="Ingrese Apellido" value="<?= set_value('last_name', $last_name) ?>" data-rule-required="true"/>
                                            ...
                                            <div class="col-md-6 <?= ($user_type_id == 1) ? 'hidden' : '' ?>">
                                                <div class="form-group <?= (form_error('user_type_id')) ? 'has-error' : '' ?>">
                                                    <label>Origen</label>
                                                    <select name="user_origin_id" class="form-control" data-rule-required="true">
                                                        <option value="">Selecione...</option>
                                            ...
                                            <div class="col-md-6 <?= ($creating_user_id) ? 'hidden' : '' ?> <?= ($user_type_id != 1) ? 'hidden' : '' ?>">
                                                <div class="form-group">
                                                  <label>&nbsp;</label>
                                                  <div>
                                                    <button type="button" class="btn btn-warning btn-flat" id="passwordChange">Modificar Contraseña</button>
                                                  </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 <?= ($user_type_id != 1) ? 'hidden' : '' ?>">
                                            ...
                                            <div class="col-md-12">
                                              <p>Link para compartir: http://briteproductions.com.ar/app/photographer/<?=$id?></p>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                              ...
                                              <form class="form-horizontal" id="fileUpload" method="POST" enctype="multipart/form-data">
                                                  <div class="form-group">
                                                      ...
                                                      <div class="fileupload-buttonbar clearfix">
                                                          <div class="col-lg-12">
                                                              <span class="btn btn-warning btn-flat fileinput-button">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-warning btn-flat pull-right">Guardar</button>
