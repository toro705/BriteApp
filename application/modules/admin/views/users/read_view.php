                                ...
                                <div class="box-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <a href="<?= base_url('admin/users/create/'.$type) ?>" class="btn btn-warning btn-flat"><i class="fa fa-user-plus"></i>Agregar</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-header -->
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Apellido(s) <div><a href="<?= base_url('admin/'.$module.'/read/'.$type.'/last_name/asc/'.$numrows.'/'.$start)?>" class=""><i class="fa fa-angle-up"></i></a><a href="<?= base_url('admin/'.$module.'/read/'.$type.'/last_name/desc/'.$numrows.'/'.$start)?>"><i class="fa fa-angle-down"></i></a></div></th>
                                            ...
                                            <?php foreach ($users as $k => $user) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a data-toggle="tooltip" title="Editar"        class="btn btn-warning btn-flat" href="<?= base_url('admin/users/update/'.$type.'/'.$user->id) ?>"><i class="fa fa-edit"></i></a>
                                                            <a data-toggle="tooltip" title="Ver"           class="btn btn-warning btn-flat viewAction button" href="<?= base_url('admin/users/view/'.$user->id) ?>"><i class="fa fa-eye"></i></a>
                                                            <a data-toggle="tooltip" title="Eliminar"      class="btn btn-warning btn-flat removeAction" href="<?= base_url('admin/users/delete/'.$user->id) ?>"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
