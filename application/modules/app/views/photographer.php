                ...
                <div class="row bg-2">
                    ...
                    ?>
                        <?php foreach ($photographer->images as $v) : ?>
                            ...
                            <a href="<?= base_url('public/app/files/photographers/large/'.$v->name);?>" data-label="<?=$v->label ?>" data-lightbox="works" rel="work" class="work" style="background-image:  url('<?= base_url('public/app/files/photographers/medium/'.$v->name);?>">
                                <span class="work_overlay transition"></span>
                            </a>

                        <?php endforeach ?>
                        <?php foreach ($photographer->videos as $v) : ?>
                                <div class="clearfix">  </div>
                                <div class="text-center color-1" style="margin-top: 80px">
                                    <h3 class="text-center"><?=$v->label ?></h3>
                                     <video width="100%" style="max-width: 800px"  height="240" controls>
                                      <source src="<?= base_url('public/app/files/photographers/original/'.$v->name);?>" type="video/mp4">
                                    </video> 
                                </div>
